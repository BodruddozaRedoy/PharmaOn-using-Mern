...
export default function BlogSection() {
  return (
    <div className=" md:mx-10 mx-3 dark:text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 ">
        <div className="rounded overflow-hidden shadow-lg flex flex-col bg-white dark:bg-slate-800">
          <a href="#"></a>
          ...
          <div className="px-6 py-4 mb-auto">
            ...
            >
              5 Essential Tips to Boost Your Immunity
            </a>
            <p className="text-gray-500 text-sm">
              Learn how vitamins, sleep, and hydration play a key role in
              maintaining your immune system.
            </p>
          </div>
          <div className="px-6 py-3 flex flex-row items-center justify-between bg-white dark:bg-slate-800">
            <sp
              dark:text-whitean
              href="#"
              className="py-1 text-xs font-regular text-gray-900 dark:text-white mr-1 flex flex-row items-center"
            >
              <svg
                height="13px"
                width="13px"
              ...
              <span className="ml-1 dark:text-white">6 mins ago</span>
            </sp>
            ...
            >
              ...
              <span className="ml-1 dark:text-white">39 Comments</span>
            </span>
          </div>
        </div>
        ...
        <div className="rounded overflow-hidden shadow-lg flex flex-col bg-white dark:bg-slate-800">
          ...
          <div className="px-6 py-4 mb-auto">
            ...
            <p className="text-gray-500 text-sm">
              Tips on keeping prescriptions safe, effective, and out of reach of
              children.
            </p>
          </div>
          <div className="px-6 py-3 flex flex-row items-center justify-between bg-white dark:bg-slate-800">
            ...
            >
              ...
              <span className="ml-1 dark:text-white"> 10 days ago</span>
            </span>
            ...
            >
              ...
              <span className="ml-1 dark:text-white">0 Comments</span>
            </span>
          </div>
        </div>
        ...
        <div className="rounded overflow-hidden shadow-lg flex flex-col bg-white dark:bg-slate-800">
          ...
          <div className="px-6 py-4 mb-auto">
            ...
            <p className="text-gray-500 text-sm">
              A simple guide to help you understand dosage, instructions, and
              precautions on your meds.
            </p>
          </div>
          <div className="px-6 py-3 flex flex-row items-center justify-between bg-white dark:bg-slate-800">
            <span
            ...
            >
              ...
              <span className="ml-1 dark:text-white">16 hours ago</span>
            </span>
            ...
            >
              ...
              <span className="ml-1 dark:text-white">9 Comments</span>
            </span>
          </div>
        </div>
        ...
        <div className="rounded overflow-hidden shadow-lg flex flex-col bg-white dark:bg-slate-800">
          ...
          <div className="px-6 py-4 mb-auto">
            <a
              ...
              className="font-medium text-lg inline-block hover:text-primary transition duration-500 ease-in-out  mb-2"
            >
              Preventing the Flu: What You Need to Know This Season
            </a>
            <p className="text-gray-500 text-sm">
              Stay protected this flu season with tips on vaccines, hygiene, and
